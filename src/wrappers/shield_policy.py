...
def shield_policy(model, eval_env: ModelFreeShieldWrapper = None,
                  force_eval: bool = False):
    assert eval_env is None or isinstance(eval_env, ModelFreeShieldWrapper), "eval_env must be a ModelFreeShieldWrapper"
