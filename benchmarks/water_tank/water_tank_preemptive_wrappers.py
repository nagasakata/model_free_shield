...
from src.wrappers.stabilizing_shield_wrapper import StabilizingShieldWrapper
from src.shields.stabilizing_shield import StabilizingShield

class WaterTankStabilizingShieldWrapper(StabilizingShieldWrapper):
    def __init__(self, env, ltl_formula: str, min_depth: int = 0, punish=False,
                 max_shield_life=10, no_pdb=True):
        shield = StabilizingShield()
